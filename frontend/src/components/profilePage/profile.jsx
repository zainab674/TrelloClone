...
const MeProfile = () => {
    const { me, loading } = useAuth();  // Add a loading state if available
        ...
        <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-8 p-8 bg-gray-50 min-h-screen">
            ...
            <div className="w-full md:w-1/4 bg-white rounded-lg p-6 shadow-md">
                <ul className="space-y-4">
                    ...
                    <li className="text-gray-500 hover:text-blue-600 cursor-pointer">Team Member</li>
                    <li className="text-gray-500 hover:text-blue-600 cursor-pointer">Notifications</li>
                    <li className="text-gray-500 hover:text-blue-600 cursor-pointer">Billing</li>
                    <li className="text-gray-500 hover:text-blue-600 cursor-pointer">Data Export</li>
                    <li className="text-red-500 hover:text-red-600 cursor-pointer font-semibold">Delete Account</li>
                </ul>
            </div>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div className="md:col-span-2">
                                    ...
                                    <p className="text-lg font-medium">{me.profile.description ? me.profile.description : "Description will show here"}</p>
                                </div>
                            </div>
                        </div>
                    </>
                                    ...
                                    {me.projects.map((project) => (
                                        <div key={project._id} className="bg-white rounded-lg shadow-md p-6 hover:shadow-xl transition-shadow duration-200">
                                            ...
                                            <div className="flex justify-between">
                                                <button className="bg-blue-600 text-white py-2 px-4 rounded hover:bg-blue-700">View</button>
                                    ...
                                    >
                                        ...
                                        {/* <div className="flex-1">
                                            ...
                                            {task.assignedTo.length > 0 ? (
                                                <img
                                                    src={userPhotos[task.assignedTo[0]] || 'https://example.com/default-photo.jpg'}
                                                    alt="Member"
