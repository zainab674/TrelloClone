...
export declare class PostsService {
    private schemaModel;
    constructor(schemaModel: Model<PostDocument>);
    ...
    update(id: string, updateDataDto: UpdatePostDto, cid: string): Promise<{
        data: import("mongoose").Document<unknown, {}, PostDocument> & PostEntity & import("mongoose").Document<any, any, any> & {
    ...
    deletePost(id: string): Promise<import("mongoose").ModifyResult<import("mongoose").Document<unknown, {}, PostDocument> & PostEntity & import("mongoose").Document<any, any, any> & {
        _id: import("mongoose").Types.ObjectId;
    }>>;
