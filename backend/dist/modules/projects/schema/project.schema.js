...
exports.userJsonSchema = exports.ProjectSchema = exports.ProjectEntity = void 0;
...
__decorate([
    ...
    (0, swagger_1.ApiProperty)({ description: "Title of the Project" }),
...
__decorate([
    ...
    (0, mongoose_1.Prop)({ type: [mongoose_2.default.Schema.Types.ObjectId], ref: 'TaskEntity', default: [] }),
    __metadata("design:type", Array)
...
const ProjectSchema = mongoose_1.SchemaFactory.createForClass(ProjectEntity);
